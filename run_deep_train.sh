...
models=("FCN" "MCDCNN" "MLP" "ConvTran" "InceptionTime" "LSTMFCN" "ResNet")
...
do
    ...
    do
        ...
        do
            ...
            mlflow run --experiment-name=$exp_name -e main.py -P gpu=$1 -P cache_dir=$2 -P dataset=$d -P model=$m -P fold=$f ./tsc
        done
