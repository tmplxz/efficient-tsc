...
do
    ...
    do
        ...
        do
            for p in "${prune[@]}"
            do
                for b in "64" "128" "256" "512" "1024" "2048" "4096" "8192" "16384"
                do
                    ...
                    timeout 14400 mlflow run --experiment-name=$exp_name -e main.py -P gpu=$1 -P cache_dir=$2 -P use_pretrained=$4 -P dataset=$d -P model=$m -P fold=$f -P batch_size=$bs -P seed=-1 -P prune_rate=$p ./ts_archive_experiments
                done
            done
        done
